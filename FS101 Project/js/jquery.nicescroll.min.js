    ...
    var x = window.MutationObserver || window.WebKitMutationObserver || !1,
        ...
        S = function(k, c) {
            ...
            function d(b, g, l) {
                g = b.css(g);
                b = parseFloat(g);
                return isNaN(b) ? (b = y[g] || 0,
                    l = 3 == b ? l ? a.win.outerHeight() - a.win.innerHeight() : a.win.outerWidth() - a.win.innerWidth() : 1,
                    a.isie8 && b && (b += 1),
                    l ? b : 0) : b
            }
            ...
            function q(b, g, c) {
                ...
                0 == b.deltaMode ? (d = -Math.floor(a.opt.mousescrollstep / 54 * b.deltaX),
                    f = -Math.floor(a.opt.mousescrollstep / 54 * b.deltaY)) : 1 == b.deltaMode && (d = -Math.floor(b.deltaX * a.opt.mousescrollstep),
                    f = -Math.floor(b.deltaY * a.opt.mousescrollstep));
                g && a.opt.oneaxismousemode && 0 == d && f && (d = f,
                    f = 0,
                    c && (0 > d ? a.getScrollLeft() >= a.page.maxw : 0 >= a.getScrollLeft()) && (f = d,
                        d = 0));
            ...
            if (k)
                for (var H in a.opt)
                    "undefined" != typeof k[H] && (a.opt[H] = k[H]);
            ...
            !f.cantouch || f.isios || f.isandroid || !f.iswebkit && !f.ismozilla || (this.istouchcapable = !0,
                f.cantouch = !1);
            a.opt.enablemouselockapi || (f.hasmousecapture = !1,
                f.haspointerlock = !1);
            ...
            this.doRailClick = function(b, g, c) {
                ...
                a.railslocked || (a.cancelEvent(b),
                    g ? (g = c ? a.doScrollLeft : a.doScrollTop,
                        ...
                        g(f)) : (g = c ? a.doScrollLeftBy : a.doScrollBy,
                        f = c ? a.scroll.x : a.scroll.y,
            ...
            this.init = function() {
                a.saved.css = [];
                if (f.isie7mobile || f.isoperamini)
                    return !0;
                ...
                if (!a.ispage || !f.cantouch && !f.isieold && !f.isie9mobile) {
                    ...
                    for (K in k)
                        h = k[K],
                        (d = a.opt.railpadding[h]) ? l.css("padding-" + h, d + "px") : a.opt.railpadding[h] = 0;
                    l.append(c);
                    ...
                    a.rail = l;
                    c = a.rail.drag = !1;
                    !a.opt.boxzoom || a.ispage || f.isieold || (c = document.createElement("div"),
                        a.bind(c, "click", a.doZoom),
                        ...
                        f.cantouch && a.opt.gesturezoom && (a.ongesturezoom = function(b) {
                    ...
                    a.opt.horizrailenabled && (a.css(b, {
                        ...
                        m.height = Math.max(parseFloat(a.opt.cursorwidth), c.outerHeight()),
                        m.css({
                            height: m.height + "px",
                            zIndex: a.zindex,
                            background: a.opt.background
                    ...
                    a.ispage ? (l.css({
                        ...
                        a.railh && (m.css({
                            ...
                            m && (m.css({
                                ...
                                b.append(m))) : (a.isfixed = "fixed" == a.win.css("position"),
                        ...
                        f.isie && a.opt.disableoutline && a.win.attr("hideFocus", "true"),
                        f.iswebkit && a.opt.disableoutline && a.win.css({
                            outline: "none"
                        }));
                    !1 === a.opt.autohidemode ? (a.autohidedom = !1,
                        ...
                        f.isie8 && (a.autohidedom = a.autohidedom.add(a.cursor)),
                    ...
                    if (f.isie9mobile)
                        ...
                        a.onmangotouch = function() {
                            ...
                            if (0 != Math.round(Math.sqrt(Math.pow(f, 2) + Math.pow(g, 2)))) {
                                ...
                                80 < e - a.mangotouch.tm || a.mangotouch.dry != d || a.mangotouch.drx != l ? (a.scrollmom.stop(),
                                    ...
                                    a.mangotouch.dry = d,
                                    a.mangotouch.drx = l,
                                    a.mangotouch.tm = e) : (a.scrollmom.stop(),
                                    a.scrollmom.update(a.mangotouch.sx - f, a.mangotouch.sy - g),
                                    a.mangotouch.tm = e,
                        ...
                        if (f.cantouch || a.istouchcapable || a.opt.touchbehavior || f.hasmstouch) {
                            ...
                            a.ontouchstart = function(b) {
                                ...
                                if (!a.railslocked) {
                                    ...
                                    a.opt.touchbehavior && a.isiframe && f.isie && (g = a.win.position(),
                                    ...
                                    if (!f.cantouch && !this.istouchcapable && !b.pointerType) {
                                        if (!c || !/INPUT|SELECT|TEXTAREA/i.test(c.nodeName))
                                            return !a.ispage && f.hasmousecapture && c.setCapture(),
                            ...
                            a.ontouchmove = function(b, c) {
                                if (!a.rail.drag || b.targetTouches && a.opt.preventmultitouchscrolling && 1 < b.targetTouches.length || b.pointerType && 2 != b.pointerType && "touch" != b.pointerType)
                                    return !1;
                                if (2 == a.rail.drag.pt) {
                                    if (f.cantouch && f.isios && "undefined" == typeof b.original)
                                        return !0;
                                    a.hasmoving = !0;
                                    ...
                                    a.railh && a.railh.scrollable && (r = a.isrtlmode ? w - a.rail.drag.sl : a.rail.drag.sl - w,
                                        a.ishwscroll && a.opt.bouncescroll ? 0 > r ? r = Math.round(r / 2) : r > a.page.maxw && (r = a.page.maxw + Math.round((r - a.page.maxw) / 2)) : (0 > r && (h = r = 0),
                                            r > a.page.maxw && (r = a.page.maxw,
                                                h = 0)));
                                    g = !1;
                                    if (a.rail.drag.dl)
                                        g = !0,
                                        "v" == a.rail.drag.dl ? r = a.rail.drag.sl : "h" == a.rail.drag.dl && (k = a.rail.drag.st);
                                    else {
                                        d = Math.abs(d);
                                        var w = Math.abs(w),
                                        ...
                                        if ("v" == a.rail.drag.ck) {
                                            ...
                                            w > m && (a.rail.drag.dl = "f",
                                                e("body").scrollTop(e("body").scrollTop()))
                                        } else if ("h" == a.rail.drag.ck) {
                                            if (w > m && d <= .3 * w)
                                                return a.rail.drag = !1, !0;
                                            d > m && (a.rail.drag.dl = "f",
                                    ...
                                    a.synched("touchmove", function() {
                                        a.rail.drag && 2 == a.rail.drag.pt && (a.prepareTransition && a.prepareTransition(0),
                                            ...
                                            a.scrollmom.update(h, l),
                                            a.railh && a.railh.scrollable ? (a.setScrollLeft(r),
                                                a.showCursor(k, r)) : a.showCursor(k),
                        ...
                        if (f.cantouch || a.opt.touchbehavior)
                            ...
                            a.onclick = f.isios ? !1 : function(b) {
                    ...
                    a.onkeypress = function(b) {
                        ...
                        b = b ? b : window.e;
                        var c = a.getTarget(b);
                        if (c && /INPUT|TEXTAREA|SELECT|OPTION/.test(c.nodeName) && (!c.getAttribute("type") && !c.type || !/submit|button|cancel/i.tp) || e(c).attr("contenteditable"))
                            return !0;
                    ...
                    !1 !== x && (a.observerbody = new x(function(b) {
                            b.forEach(function(b) {
                                if ("attributes" == b.type)
                                    return e("body").hasClass("modal-open") && !e.contains(e(".modal-dialog")[0], a.doc[0]) ? a.hide() : a.show()
                            });
                    ...
                    a.ispage || a.haswrapper || (!1 !== x ? (a.observer = new x(function(b) {
                        ...
                        f.isie9 && a.win[0].attachEvent("onpropertychange", a.onAttributeChange),
            ...
            this.onResize = function(b, c) {
                ...
                if (a.page.maxh == d && a.page.maxw == f && a.view.w == h && a.view.h == e) {
                    if (a.ispage)
                        return a;
                    d = a.win.offset();
                    if (a.lastposition && (f = a.lastposition,
            ...
            this.bind = function(b, c, d, e) {
                ...
                "mousewheel" == c ? "onwheel" in a.win ? a._bind(h, "wheel", d, e || !1) : (b = "undefined" != typeof document.onmousewheel ? "mousewheel" : "DOMMouseScroll",
                    p(h, b, d, e || !1),
                    "DOMMouseScroll" == b && p(h, "MozMousePixelScroll", d, e || !1)) : h.addEventListener ? (f.cantouch && /mouseup|mousedown|mousemove/.test(c) && a._bind(h, "mousedown" == c ? "touchstart" : "mouseup" == c ? "touchend" : "touchmove", function(a) {
                        if (a.touches) {
                    ...
                    a._bind(h, c, d, e || !1),
                    f.cantouch && "mouseup" == c && a._bind(h, "touchcancel", d, e || !1)) : a._bind(h, c, function(b) {
                ...
                this.doScrollPos = function(b, c, d) {
                    ...
                    a.timer = setTimeout(function() {
                        ...
                        0 < h && (!a.scrollrunning && a.onscrollstart && a.onscrollstart.call(a, {
                            ...
                            f.transitionend ? a.scrollendtrapped || (a.scrollendtrapped = !0,
                                a.bind(a.doc, f.transitionend, a.onScrollTransitionEnd, !1)) : (a.scrollendtrapped && clearTimeout(a.scrollendtrapped),
                ...
                this.doScrollPos = function(b, c, d) {
                    function f() {
                        ...
                        2 == b ? (a.timer = 0,
                            ...
                            a.bzscroll = !1,
                            a.scrollrunning = !1,
                            0 > e ? e = 0 : e > a.page.maxh && (e = a.page.maxh),
            ...
            this.doScrollBy = function(b, c) {
                ...
                if (d > a.page.maxh && f >= a.page.maxh)
            ...
            this.doScrollLeftBy = function(b, c) {
                ...
                a.cursorfreezed = !1;
                f = a.getScrollLeft(!0);
                if (0 > d && 0 >= f || d > a.page.maxw && f >= a.page.maxw)
                    return a.noticeCursor();
                a.doScrollLeft(d)
            };
            ...
            this.doZoomIn = function(b) {
                if (!a.zoomactive) {
                    ...
                    f.isios4 && (a.zoomrestore.scrollTop = e(window).scrollTop(),
            ...
            this.doZoomOut = function(b) {
                if (a.zoomactive)
                    return a.zoomactive = !1,
                        ...
                        f.isios4 && e(window).scrollTop(a.zoomrestore.scrollTop),
                        a.rail.css({
                            "z-index": a.zindex
                        }),
                        a.zoom.css({
        ...
        M = function(e) {
            ...
            this.doSnapy = function(e, k) {
                ...
                0 > k ? (k = 0,
                    ...
                    d = !0);
                0 > e ? (e = 0,
                    d = !0) : e > c.nc.page.maxw && (e = c.nc.page.maxw,
                    d = !0);
                ...
                if (c.speedy && d && c.speedy || e) {
                    ...
                    var f = c.lastscrollx,
                        ...
                        v = function() {
                            ...
                            c.speedx && (f = Math.floor(c.lastscrollx - c.speedx * (1 - c.demulxy)),
                                c.lastscrollx = f,
                                0 > f || f > a) && (d = .1);
                            c.speedy && (t = Math.floor(c.lastscrolly - c.speedy * (1 - c.demulxy)),
                                c.lastscrolly = t,
                                0 > t || t > q) && (d = .1);
                            ...
                            1 > c.demulxy ? c.timer = setTimeout(v, u) : (c.stop(),
                                c.nc.hideCursor(),
                                c.doSnapy(f, t))
                        };
                    v()
